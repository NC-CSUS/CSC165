...
public class GameObject
{
	...
	public GameObject(GameObject p, ObjShape s, AnimatedShape animShape, TextureImage t){
		this.animShape = animShape;
		shape = s;
		texture = t;
		parent = p;
		parent.addChild(this);
	...
	/** returns a reference to the AnimatedShape associated with this GameObject*/
	public AnimatedShape getAnimShape(){
		if(animShape != null){
			return animShape;
		}
		return null;
